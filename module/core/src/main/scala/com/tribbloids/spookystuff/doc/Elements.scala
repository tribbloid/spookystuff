...
//  }
  ...
  override def findAll(selector: DocSelector): Elements[Unstructured] = Elements(unbox.flatMap(_.findAll(selector)))
  ...
  override def children(selector: DocSelector): Elements[Unstructured] = Elements(
