...
case class SpookyConf(
    ...
    //
    auditing: Auditing = Auditing.originalAndNormalised,
    ...
    //
    selectSampling: DownSampling = DownSampling.Identity,
    fetchSampling: DownSampling = DownSampling.Identity, // takes remote actions and cost much more than flatten.
    exploreSampling: DownSampling = DownSampling.Identity, // takes remote actions and cost much more than flatten.
    //
  ...
  def previewMode: SpookyConf = {
    ...
    val sampler: DownSampling.FirstN = DownSampling.FirstN(1)
