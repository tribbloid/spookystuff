...
package gradle.kotlin.dsl.plugins._f1632ea5410b4e0f4ad0d3686cc4e45f
...
/**
 * The `io.github.cosmicsilence` plugin group.
 */
@org.gradle.api.Generated
internal
class `IoGithubCosmicsilencePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `io.github.cosmicsilence`.
 */
internal
val `IoGithubPluginGroup`.`cosmicsilence`: `IoGithubCosmicsilencePluginGroup`
    get() = `IoGithubCosmicsilencePluginGroup`(plugins)


/**
 * The `io.github.cosmicsilence.scalafix` plugin implemented by [io.github.cosmicsilence.scalafix.ScalafixPlugin].
 */
internal
val `IoGithubCosmicsilencePluginGroup`.`scalafix`: PluginDependencySpec
    get() = plugins.id("io.github.cosmicsilence.scalafix")
