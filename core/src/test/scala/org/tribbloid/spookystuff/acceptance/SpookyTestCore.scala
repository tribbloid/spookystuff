...
import org.tribbloid.spookystuff.factory.{HtmlUnitDriverFactory, ChromeDriverFactory, FirefoxDriverFactory}
...
trait SpookyTestCore extends FunSuite {
  ...
  lazy val spooky: SpookyContext = new SpookyContext(sql, ChromeDriverFactory)
  val result = doMain()
