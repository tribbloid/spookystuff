...
class SemanticSearchTransformer(
                               override val uid: String =
                               classOf[SemanticSearchTransformer].getCanonicalName + "_" + UUID.randomUUID().toString
  ...
  def test(spooky: SpookyContext): Unit = {
    ...
    val transformer = new SemanticSearchTransformer()
      .setInputCol("input")
      .setMaxPages(2)
      .setPageNumCol("page")
      .setIndexCol("index")
